...
namespace PushSharp
{
    public static class WindowsPhonePushBrokerExtensions
    {
        ...
        public static void RegisterWindowsPhoneService(this PushBroker broker, WindowsPhonePushChannelSettings channelSettings, Func<IPushChannelFactory> factoryProvider, string applicationId, IPushServiceSettings serviceSettings = null)
        {
            var service = new WindowsPhonePushService(factoryProvider(), channelSettings, serviceSettings);
